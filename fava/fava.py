...
class VAE(keras.Model):
    def __init__(self, inputs, outputs, opt, x_train, x_test, batch_size, original_dim, epochs = 100, intermediate_dim = 500, latent_dim = 100):
...
def main():
    ...
    vae = VAE(inputs, outputs, opt, x_train, x_test, batch_size, original_dim, intermediate_dim = intermediate_dim, latent_dim = latent_dim, epochs=epochs)
